package com.srz.androidtools.viewpagertitle;
...
public class ViewPagerTabs extends ViewGroup implements OnPageChangeListener {
	...
	private int mBackgroundColorPressed = 0x99e0e0e0;

	private int mTextColor = ViewPagerTabConstant.PAGER_SIDE_TEXT_COLOR;        //side color
	private int mTextColorCenter = ViewPagerTabConstant.PAGER_CENTER_TEXT_COLOR;  //center color

	private int mLineColor = 0x00000000;
	private int mLineColorCenter = ViewPagerTabConstant.PAGER_UNDERLINE_COLOR;  //underline color
//	private int mLineColorCenter = 0xFF91A438;
	...
	public ViewPagerTabs(Context context, AttributeSet attrs, int defStyle) {
		...
		this.setBackgroundResource(R.color.pager_background_color);
		mContext = context;
		...
		mTextColor = a.getColor(R.styleable.ViewPagerTabs_textColor2, mTextColor);
		...
		mTextSize = a.getDimension(R.styleable.ViewPagerTabs_textSize2, mTextSize);
	...
	/**
	 * Binds the {@link android.support.v4.view.ViewPager} to this instance
	 *
	 * @param pager
	 *          An instance of {@link android.support.v4.view.ViewPager}
	 */
	...
	/**
	 * Binds the {@link android.support.v4.view.ViewPager} to this instance and sets the current position
	 *
	 * @param pager
	 *          An instance of {@link android.support.v4.view.ViewPager}
	 * @param position
	 *          Initial position of the {@link android.support.v4.view.ViewPager}
	 */
